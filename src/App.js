...
function App() {
    ...
    return (
        <div className="w-full h-screen bg-gradient-to-b from-blue-200 to-green-200 relative overflow-hidden">
                ...
                <div style={{zIndex: 10}} className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-8 rounded-lg text-center">
                        ...
                        <p className="text-gray-500 mb-6">
                            Press SPACE or ↑ to jump and avoid obstacles
                        </p>
                        <button
                            onClick={startGame}
            ...
            {gameState === 'playing' && (
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-center">
                    <p className="bg-black bg-opacity-50 px-4 py-2 rounded">
                        SPACE or ↑ - Jump | Catch the Bitcoin ₿
                    </p>
                </div>
            )}
